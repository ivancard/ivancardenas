      ...
      {modal && (
        <Modal toggleModal={toggleModal}>
          ...
          <div className='img-modal-container'>
            {imgHigh && <img className='img-modal' src={imgHigh} alt={title} />}
            {imgPhone && (
              <img className='img-phone' src={imgPhone} alt={title} />
            )}
          </div>
          ...
          <div className='links'>
            ...
            {videoUrl && (
              <p className='video-url'>
                Video de demostración y explicación <a href={videoUrl}>Aqui</a>
              </p>
            )}
          </div>
